...
#### Teamwork
- NO job can be done as well as when we work on it with <span style="color:#ef8a17">_friends_</span>
...
- Live healthy
#### Break the rules
- Sometimes it's just better to leave all the rules behind and just let the <span style="color:#ef8a17">_flow_</span> take you with it
